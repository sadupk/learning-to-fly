  ...
  output$nas_delay_Plot <- renderPlot({
    ...
    if(input$delay=="SECURITY DELAY"){
      ...
      ggplot(day, aes(x = factor(month, levels = month.abb), y = DEP_TIME/100)) +
        ...
        scale_y_continuous(breaks = seq(0, 24, by = 1))+
        scale_colour_gradient(low = "#EF597B", high = "red",limits=c(0,1250))+
      ...
      ggplot(day, aes(x = factor(month, levels = month.abb), y = DEP_TIME/100)) +
        ...
        scale_y_continuous(breaks = seq(0, 24, by = 1))+
        scale_colour_gradient(low = "#73B66B", high = "#006400",limits=c(0,1250))+
        labs(x="2017 Months", y="Hour")+scale_size_continuous(guide=FALSE)+labs(colour = "No of Delays")}
      ...
      ggplot(day, aes(x = factor(month, levels = month.abb), y = DEP_TIME/100)) +
        ...
        scale_y_continuous(breaks = seq(0, 24, by = 1))+
        scale_colour_gradient(low = "#FFCB18", high = "#666600",limits=c(0,1250))+
        labs(x="2017 Months", y="Hour")+scale_size_continuous(guide=FALSE)+labs(colour = "No of Delays")}
      ...
      ggplot(day, aes(x = factor(month, levels = month.abb), y = DEP_TIME/100)) +
        ...
        scale_y_continuous(breaks = seq(0, 24, by = 1))+
        scale_colour_gradient(low = "#29A2C6", high = "#000066",limits=c(0,1250))+
        labs(x="2017 Months", y="Hour")+scale_size_continuous(guide=FALSE)+labs(colour = "No of Delays")}
